...
DEVICE_PLATFORM_DICT = {
    "aligenie": {"cn_name": "天猫精灵"},
    "dueros": {"cn_name": "小度"},
    "jdwhale": {"cn_name": "小京鱼"},
    "weixin": {"cn_name": "企业微信"},
}
DEVICE_TYPE_DICT = {
    "airpurifier": {"cn_name": "空气净化器", "icon": "mdi-air-conditioner"},
    "climate": {"cn_name": "空调", "icon": "mdi-air-conditioner"},
    "fan": {"cn_name": "风扇", "icon": "mdi-pinwheel"},
    "light": {"cn_name": "灯", "icon": "mdi-lightbulb"},
    "media_player": {"cn_name": "播放器", "icon": "mdi-television-classic"},
    "switch": {"cn_name": "开关", "icon": "mdi-toggle-switch"},
    "sensor": {"cn_name": "传感器", "icon": "mdi-access-point-network"},
    "cover": {"cn_name": "窗帘", "icon": "mdi-window-shutter"},
    "vacuum": {"cn_name": "扫地机", "icon": "mdi-robot-vacuum-variant"},
}
DEVICE_ACTION_DICT = {
    "turn_on": {"cn_name": "打开"},
    "turn_off": {"cn_name": "关闭"},
...
DEVICE_ATTRIBUTE_DICT = {
    ...
    "formaldehyde": {"scale": "mg/m3", "legalValue": "DOUBLE", "cn_name": "甲醛浓度"},
